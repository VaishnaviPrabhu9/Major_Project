...
# Load the dataset
file_path = 'D:/project_10/dass_new/stress/stress_dataset.csv'  # Replace with the actual path to your stress dataset
...
# Encode the target column (for example: 'Stressed' / 'Not Stressed')
...
response_encoder_file = 'response_encoder.pkl'
